            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">April 11, 2024</bdt>
                </span>
              </span>
            </strong>
          </span></p>
      ...
      <div data-custom-class="body">
        ...
        <div>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">aras0665yusuf@gmail.com</bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/4e09e410-9f8c-4e8e-a4c9-8be480e881ca"
                    ...
                    <div style={{ lineHeight: "1.5" }}>
                      ...
                      <ul>
                        <li style={{ lineHeight: "1.5" }}>
                          ...
                          <a data-custom-class="link" href="#privacyrights">
                            <span
                              style={{ fontSize: 15, color: "rgb(0, 58, 250)" }}
                            >
                              <span
                                style={{
                                  fontSize: 15,
                                        ...
                                        <li style={{ lineHeight: "1.5" }}>
                                          <span data-custom-class="body_text">
                                            <span style={{ fontSize: 15 }}>
                                              ...
                                              relevant advertising content for
                                              our users
                                              <bdt className="statement-end-if-in-editor" />
                                            </span>
                                          </span>
                                                  ...
                                                  >
                                                    <span data-custom-class="body_text">
                                                      ...
                                                      <em>
                                                        ...
                                                        that we may link to or
                                                        who advertise on our
                                                ...
                                                >
                                                  ...
                                                  >
                                                    <span data-custom-class="body_text">
                                                      ...
                                                      and/or contain
                                                      advertisements from third
                                                      parties that are not
                                                      affiliated with us and
                                                      which may link to other
                                                      websites, services, or
                                                      applications. Accordingly,
                                                      we do not make any
                                                      guarantee regarding any
                                                      such third parties, and we
                                                      will not be liable for any
                                                      loss or damage caused by
                                                      the use of such
                                                      third-party websites,
                                                      services, or applications.
                                                      The inclusion of a link
                                                      towards a third-party
                                                      website, service, or
                                                      application does not imply
                                                      an endorsement by us. We
                                                      cannot guarantee the
                                                      safety and privacy of data
                                                      you provide to any third
                                                      parties. Any data
                                                      collected by third parties
                                                      is not covered by this
                                                      privacy notice. We are not
                                                      responsible for the
                                                      content or privacy and
